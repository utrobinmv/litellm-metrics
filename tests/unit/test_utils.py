...
from litellm_metrics.dashboard import Dashboard, fmt_bytes, fmt_dollars, fmt_time, fmt_tokens, fmt_uptime
...
class TestFormatting:
    ...
    def test_fmt_dollars(self):
        """fmt_dollars: форматы $."""
        assert fmt_dollars(0.0042) == "$0.0042"
        assert fmt_dollars(42.5) == "$42.5000"
        assert "K" in fmt_dollars(1500)
        assert "M" in fmt_dollars(1_500_000)
